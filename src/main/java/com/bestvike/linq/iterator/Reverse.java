...
public final class Reverse {
    ...
    private static final class ReverseIterator<TSource> extends Iterator<TSource> implements IIListProvider<TSource> {
        private final IEnumerable<TSource> source;
        private Array<TSource> buffer;

        private ReverseIterator(IEnumerable<TSource> source) {
            assert source != null;
            this.source = source;
        }
