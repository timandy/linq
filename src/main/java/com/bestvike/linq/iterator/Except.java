...
public final class Except {
    ...
    private static final class ExceptIterator<TSource> extends AbstractIterator<TSource> {
        ...
        private ExceptIterator(IEnumerable<TSource> first, IEnumerable<TSource> second, IEqualityComparer<TSource> comparer) {
            this.first = first;
            this.second = second;
