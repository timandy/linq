...
final class AppendPrepend {
    ...
    private static abstract class AppendPrependIterator<TSource> extends Iterator<TSource> implements IIListProvider<TSource> {
    ...
    private static final class AppendPrepend1Iterator<TSource> extends AppendPrependIterator<TSource> {
        ...
        public AppendPrependIterator<TSource> append(TSource item) {
            return this.appending
                    ? new AppendPrependN<>(this.source, null, new SingleLinkedNode<>(this.item).add(item), 0, 2)
                    : new AppendPrependN<>(this.source, new SingleLinkedNode<>(this.item), new SingleLinkedNode<>(item), 1, 1);
        }

        public AppendPrependIterator<TSource> prepend(TSource item) {
            return this.appending
                    ? new AppendPrependN<>(this.source, new SingleLinkedNode<>(item), new SingleLinkedNode<>(this.item), 1, 1)
                    : new AppendPrependN<>(this.source, new SingleLinkedNode<>(this.item).add(item), null, 2, 0);
        }
    ...
    private static final class AppendPrependN<TSource> extends AppendPrependIterator<TSource> {
        ...
        public Iterator<TSource> clone() {
            return new AppendPrependN<>(this.source, this.prepended, this.appended, this.prependCount, this.appendCount);
        }
        ...
        public AppendPrependIterator<TSource> append(TSource item) {
            ...
            return new AppendPrependN<>(this.source, this.prepended, appended, this.prependCount, this.appendCount + 1);
        }

        public AppendPrependIterator<TSource> prepend(TSource item) {
            SingleLinkedNode<TSource> prepended = this.prepended != null ? this.prepended.add(item) : new SingleLinkedNode<>(item);
            return new AppendPrependN<>(this.source, prepended, this.appended, this.prependCount + 1, this.appendCount);
        }
