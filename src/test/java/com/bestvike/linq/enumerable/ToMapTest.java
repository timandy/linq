...
class ToMapTest extends TestCase {
    ...
    void ToDictionary_ThrowArgumentNullExceptionWhenKeySelectorIsNull() {
        ...
        assertThrows(ArgumentNullException.class, () -> Linq.of(source).toMap(keySelector));
    }
    ...
    void ToDictionary_ThrowArgumentNullExceptionWhenValueSelectorIsNull() {
        ...
        assertThrows(ArgumentNullException.class, () -> Linq.of(source).toMap(keySelector, valueSelector));
    }
    ...
    void ToDictionary_ThrowArgumentNullExceptionWhenKeySelectorIsNullElementSelector() {
        int[] source = new int[0];
        Func1<Integer, Integer> keySelector = null;
        assertThrows(ArgumentNullException.class, () -> Linq.of(source).toMap(keySelector, e -> e));
    }
    ...
    void ToDictionary_KeySelectorThrowException() {
        ...
        assertThrows(InvalidOperationException.class, () -> Linq.of(source).toMap(keySelector));
    }
    ...
    void ToDictionary_ValueSelectorThrowException() {
        ...
        assertThrows(InvalidOperationException.class, () -> Linq.of(source).toMap(keySelector, valueSelector));
    }
    ...
    void ThrowsOnNullKey() {
        ...
        Linq.of(source).toMap(e -> e.Name); // Doesn't throw;
        ...
        Linq.of(sourceF).toMap(e -> e.Name);
    }
    ...
    void ThrowsOnNullKeyValueSelector() {
        ...
        Linq.of(source).toMap(e -> e.Name, e -> e); // Doesn't throw;
        ...
        Linq.of(sourceF).toMap(e -> e.Name, e -> e);
    }
    ...
    void ThrowsOnDuplicateKeys() {
        ...
        Map<String, NameScore> map = Linq.of(source).toMap(e -> e.Name, e -> e);
    ...
    void EmtpySource() {
        ...
        AssertMatches(Linq.of(keys), Linq.of(elements), Linq.of(source).toMap(e -> e.Name, e -> e.Score));
    }
    ...
    void SeveralElementsCustomComparerer() {
        ...
        AssertMatches(Linq.of(keys), Linq.of(source), Linq.of(source).toMap(e -> e.Name));
    }
    ...
    void NullCoalescedKeySelector() {
        ...
        AssertMatches(Linq.of(keys), Linq.of(elements), Linq.of(source).toMap(e -> e == null ? Empty : e, e -> e));
    }

    @Test
    void testToMap() {
        Map<Integer, Employee> map = Linq.of(emps).toMap(emp -> emp.empno);
    ...
    void testToMapWithSelector() {
        Map<Integer, String> map = Linq.of(emps).toMap(emp -> emp.empno, emp -> emp.name);
