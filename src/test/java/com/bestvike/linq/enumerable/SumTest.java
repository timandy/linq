...
class SumTest extends TestCase {
    @Test
    void SumOfInt_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfInt_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfLong_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfLong_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfFloat_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfFloat_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfDouble_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfDouble_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfDecimal_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfDecimal_SourceIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfInt_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfInt_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfLong_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfLong_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfFloat_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfFloat_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfDouble_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfDouble_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfDecimal_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfDecimal_SelectorIsNull_ArgumentNullExceptionThrown() {
    ...
    @Test
    void SumOfInt_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Integer> sourceInt = Linq.empty();
    ...
    @Test
    void SumOfNullableOfInt_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Integer> sourceNullableInt = Linq.empty();
    ...
    @Test
    void SumOfLong_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Long> sourceLong = Linq.empty();
    ...
    @Test
    void SumOfNullableOfLong_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Long> sourceNullableLong = Linq.empty();
    ...
    @Test
    void SumOfFloat_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Float> sourceFloat = Linq.empty();
    ...
    @Test
    void SumOfNullableOfFloat_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Float> sourceNullableFloat = Linq.empty();
    ...
    @Test
    void SumOfDouble_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Double> sourceDouble = Linq.empty();
    ...
    @Test
    void SumOfNullableOfDouble_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<Double> sourceNullableDouble = Linq.empty();
    ...
    @Test
    void SumOfDecimal_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<BigDecimal> sourceDecimal = Linq.empty();
    ...
    @Test
    void SumOfNullableOfDecimal_SourceIsEmptyCollection_ZeroReturned() {
        IEnumerable<BigDecimal> sourceNullableDecimal = Linq.empty();
    ...
    @Test
    void SumOfInt_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfNullableOfInt_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfLong_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfNullableOfLong_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfFloat_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfNullableOfFloat_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfDouble_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfNullableOfDouble_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfDecimal_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfNullableOfDecimal_SourceIsNotEmpty_ProperSumReturned() {
    ...
    @Test
    void SumOfInt_SourceSumsToOverflow_OverflowExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfInt_SourceSumsToOverflow_OverflowExceptionThrown() {
    ...
    @Test
    void SumOfLong_SourceSumsToOverflow_OverflowExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfLong_SourceSumsToOverflow_OverflowExceptionThrown() {
    ...
    @Test
    void SumOfFloat_SourceSumsToOverflow_InfinityReturned() {
    ...
    @Test
    void SumOfNullableOfFloat_SourceSumsToOverflow_InfinityReturned() {
    ...
    @Test
    void SumOfDouble_SourceSumsToOverflow_InfinityReturned() {
    ...
    @Test
    void SumOfNullableOfDouble_SourceSumsToOverflow_InfinityReturned() {
    ...
    @Test
    void SumOfDecimal_SourceSumsToOverflow_OverflowExceptionThrown() {
    ...
    @Test
    void SumOfNullableOfDecimal_SourceSumsToOverflow_OverflowExceptionThrown() {
    ...
    @Test
    void SingleToNegativeInfinity() {
        float[] source = {-Float.MAX_VALUE, -Float.MAX_VALUE};
        assertTrue(Float.isInfinite(Linq.of(source).sumFloat()));
    }

    @Test
    void SingleFromSelector() {
        NameNum<Float>[] source = new NameNum[]{
                new NameNum<>("Tim", 9.5f),
    ...
    @Test
    void testSumDoubleWithSelector() {
        Double[] numbers = {null, 0d, 2d, 3d};
    ...
    @Test
    void testSumDecimalWithSelector() {
        BigDecimal[] numbers = {null, m("0"), m("2"), m("3")};
